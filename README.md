...
## Tech Stack
<p> Frontend: React, AJAX, Bootstrap, CSS, HTML </p>
<p> Backend: Flask, Python, PostgreSQL, SQLAlchemy </p>
<p> APIs: Cloudinary </p>
...
* Can click on a user from that list and be redirected to their profile page
